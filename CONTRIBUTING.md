...
The following is a set of guidelines for contributing to `linkly`, which are hosted in the [tech-thinker/linkly](https://github.com/tech-thinker/linkly) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
